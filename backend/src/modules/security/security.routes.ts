 ...
 */
securityRouter.post('/freeze-user', requireAdmin, async (req: Request, res: Response) => {
  const schema = z.object({
 ...
 * Body: { userId: string, reason: string }
 */
securityRouter.post('/unfreeze-user', requireAdmin, async (req: Request, res: Response) => {
  const schema = z.object({
    userId: z.string().min(1),
    reason: z.string().min(3),
  });
 ...
 */
securityRouter.get('/logs', requireAdmin, async (req: Request, res: Response) => {
